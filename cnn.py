...
# Network Parameters
nr_inputs = 260 # changing this will also have to change the shape from wdense1
...
class CNN(object):
    weights = {
        ...
        'wdense1': tf.Variable(tf.random_normal([4096, 1024])),
    ...
    def build(self):
        ...
        validation_size = int(0.2 * sum(dataset_len))
